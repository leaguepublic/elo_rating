...
if __name__ == "__main__":
    ...
    url_template = "http://www.goal.com/kr/%ED%94%84%EB%A6%AC%EB%AF%B8%EC%96%B4-%EB%A6%AC%EA%B7%B8/%EC%9D%BC%EC%A0%95-%EA%B2%B0%EA%B3%BC/%EB%9D%BC%EC%9A%B4%EB%93%9C-"

    for i in xrange(1, 39):
        logging.debug('crawl: %s round' % i)
        r = str(i)
        url = url_template + r + "/2kwbbcootiqqgmrzs6o5inle5" 
